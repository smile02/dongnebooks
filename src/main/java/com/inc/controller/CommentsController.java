...
public class CommentsController {
	...
	@RequestMapping(value="/comments/admin", method=RequestMethod.POST)
	public String commentsAdmin(@RequestParam int rno, @RequestParam String nickname) {
		if("관리자".equals(nickname)) {
			commentsService.commentsAdmin(rno);
			return "y";
		}else {
			return "";
		}		
